            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-12">
                            <form action="{{ route('backend.uploadPhoto',$id) }}" class="needs-validation" novalidate
                                  method="post"
                                  enctype="multipart/form-data">
                                @csrf
                                <input hidden="" name="photo_id" value="{{ $id }}">
                                <div class="mb-3">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-danger"
                                           href="{{ route('backend.deletePhoto',['model' => 'Photo','id'=>$gallery->id]) }}"><i
